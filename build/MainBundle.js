...
var _MainPage = __webpack_require__(43);
...
var _MainPage = __webpack_require__(21);

var _MainPage2 = _interopRequireDefault(_MainPage);

var _ImportAllScss = __webpack_require__(17);

var _ImportAllScss2 = _interopRequireDefault(_ImportAllScss);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_MainPage2.default, null), document.getElementById('react-root'));
...
var _PrimeMultiplicationTable2 = _interopRequireDefault(_PrimeMultiplicationTable);
...
var MainPage = function (_React$Component) {
  ...
  function MainPage(props) {
    ...
    _this.onClickGenerateButton = _this.onClickGenerateButton.bind(_this);
    _this.state = {
      primeTable: _this.newPrimeTableBuilder(3)
    };
    return _this;
  }

  _createClass(MainPage, [{
    key: "newPrimeTableBuilder",
    value: function newPrimeTableBuilder(primeNumberCount) {
      return new _PrimeMultiplicationTable2.default(primeNumberCount);
    }
  }, {
    key: "onClickGenerateButton",
    value: function onClickGenerateButton(inputText) {
      this.setState({
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "main-page" },
        _react2.default.createElement(_Nav2.default, { onClickButton: this.onClickGenerateButton }),
...
var Nav = function (_React$Component) {
  ...
  function Nav(props) {
    ...
    _this.onChangeInputBox = _this.onChangeInputBox.bind(_this);
    _this.state = {
      inputText: ""
    };
    return _this;
  ...
  _createClass(Nav, [{
    ...
    key: "onChangeInputBox",
    value: function onChangeInputBox(event) {
      this.setState({
...
Nav.propTypes = {
  onClickButton: _propTypes2.default.func
};
...
// module
exports.push([module.i, "html, body, #react-root {\n  height: 100%; }\n\nbody {\n  margin: 0; }\n", ""]);
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(11),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(10),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(12),ia=__webpack_require__(13),D=__webpack_require__(5);
...
Table.propTypes = {
  tableBuilder: _propTypes2.default.object
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./Cell.scss", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./Cell.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var PrimeMultiplicationTable = function () {
  function PrimeMultiplicationTable(primeNumberCount) {
    _classCallCheck(this, PrimeMultiplicationTable);

    this.primeNumbers = this.generatePrimeNumbers(primeNumberCount);
    this.maxPosition = this.primeNumbers.length + 1;
  }

  _createClass(PrimeMultiplicationTable, [{
    key: "valueAt",
    value: function valueAt(x, y) {
      if (x === 0 && y === 0) return "_";
